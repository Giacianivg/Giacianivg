 ...
 * Novo arquivo: services/luna/prompt-builder.js (criação é livre pelas Regras
 * de Ouro, mas só faz sentido junto com o wrapper em system-prompt.js).
 *
 * Gera o system prompt base do bot de atendimento, parametrizado.
 * Sem opts, produz a string EXATA do LUNA_SYSTEM_PROMPT atual (byte-idêntico).
 */
