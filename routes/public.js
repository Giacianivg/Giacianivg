...
// POST /api/public/book — cria a reserva online (hold). ATRÁS DE FEATURE-FLAG:
// só ativa com PUBLIC_BOOKING_ENABLED='true'. Off (default) → 503. Mesmo padrão do /pix.
const isPublicBookingEnabled = () => process.env.PUBLIC_BOOKING_ENABLED === 'true';
